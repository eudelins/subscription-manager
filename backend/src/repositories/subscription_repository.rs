...
pub async fn find_all_subscriptions(mut db: Connection<SubscriptionsDb>) -> Vec<SubscriptionDAO> {
...
pub async fn find_subscription_by_id(mut db: Connection<SubscriptionsDb>, id: i32) -> Option<SubscriptionDAO> {
...
pub async fn create_subscription(mut db: Connection<SubscriptionsDb>, new_sub: SubscriptionDAO) -> Option<SubscriptionDAO> {
    sqlx::query(
...
pub async fn delete_subscription_by_id(mut db: Connection<SubscriptionsDb>, id: i32) {
    sqlx::query(
